package com.devson.pixchive.feature.reader.viewmodel
        ...
        viewModelScope.launch {
            ...
            if (legacyFavorites.isNotEmpty()) {
                val newEntities = legacyFavorites.map { uri ->
                    com.devson.pixchive.core.data.local.FavoriteEntity(uri = uri)
                }
    ...
    fun toggleFavorite(uri: String) {
        viewModelScope.launch {
            ...
            if (isFav) {
                ...
                favoriteDao.insert(com.devson.pixchive.core.data.local.FavoriteEntity(uri))
            }
        }
    }
